                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://9fdd-139-192-223-166.ngrok-free.app"
                                ...
                                <tr>
                                    <td class="content-cell p-3"
                                        ...
                                        <h1
                                            ...
                                            One-Time Password (OTP)</h1>

                                        <table class="content" width="100%">
                                            <tr>
                                                <td>
                                                    <p>Hello,</p>
                                                    <p>You recently requested to perform an action on
                                                        {{ config('app.name') }}.
                                                    ...
                                                    <div style="text-align: center; margin: 20px 0;">
                                                        <span
                                                            style="font-size: 20px; font-weight: bold;">{{ $otp }}</span>
                                                    </div>

                                                    <p>This OTP is valid for the next 5 minutes. Please do not share
                                                        this OTP with
                                                        anyone.</p>
                                                    <p>If you did not request this OTP, please ignore this email or
                                                        contact our
                                                        support if you believe this is an error.</p>
                                                </td>
                                            </tr>
                                        </table>
